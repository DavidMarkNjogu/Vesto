        ...
        {filteredProducts.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filteredProducts.map((product) => {
              ...
              <div
                key={product._id}
                className="card bg-base-100 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 border border-transparent hover:border-primary cursor-pointer group"
              ...
              >
                <figure className="relative overflow-hidden h-64">
                  ...
                  <div className="absolute top-2 right-2 flex gap-2">
                    ...
                    {/* Visual Badge for Items in Cart */}
                    {qtyInCart > 0 && (
                      <div className="badge badge-accent shadow-md">{qtyInCart} in Cart</div>
                    )}
                  </div>
                  {product.rating && (
                ...
                <div className="card-body">
                  <h2 className="card-title text-lg line-clamp-1">{product.title}</h2>
                  {product.description && (
